package java_DSA.javabitpractice.leetcode;
...
public static void main(String[] args) {
    ...
    {2, 4}, {7, 8}, {3, 5}, {7, 6}, {8, 6}, {4, 7}, {25, 60}, {39, 52}, {16, 63}, {33, 56}
     ...
     double diagonal=0.0;
        int rows=dimensions.length-1;
        int index =Integer.MIN_VALUE;
        
        for(int i=0;i<=rows;i++){
            double length = Math.pow(dimensions[i][0],2);
            double width = Math.pow(dimensions[i][1],2);
            if(diagonal<Math.sqrt(length+width)){
